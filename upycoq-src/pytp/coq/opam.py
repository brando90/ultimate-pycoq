...
def opam_run(command: str, switch: str, cwd: Path, shell: bool = True, **kwargs) -> CompletedProcess:
...
if __name__ == '__main__':
    ...
    result = opam_run('echo "hello world" ; echo "bye world"', switch, Path.cwd())
    assert result.returncode == 0 and result.stdout.decode() == 'hello world\nbye world\n'

    result = opam_run('echo "hello world" || echo "bye world"', switch, Path.cwd())
    assert result.returncode == 0 and result.stdout.decode() == 'hello world\n'

    result = opam_run('echo "hello world" ; echo "hello world" ; echo "hello world"', switch, Path.cwd())
    assert result.returncode == 0 and result.stdout.decode() == 'hello world\nhello world\nhello world\n'

    result = opam_run('echo "hello world" ; echo "hello world" && echo "hello world" ; echo "bye world"', switch,
                      Path.cwd())
    ...
    try:
        opam_run('echo "hello world"', 'not a switch', Path.cwd())
